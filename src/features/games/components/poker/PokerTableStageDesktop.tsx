...
interface PokerTableStageDesktopProps {
...
export function PokerTableStageDesktop({
  viewModel,
  failedAvatarUrls,
  onAvatarError,
  onJoinSeat
}: PokerTableStageDesktopProps) {
  return (
    <section className="poker-gameplay-stage poker-gameplay-stage-desktop" aria-label="Poker table">
