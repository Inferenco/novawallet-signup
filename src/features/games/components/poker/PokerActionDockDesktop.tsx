...
export function PokerActionDockDesktop({
  viewModel,
  onAvatarError,
  onAbort,
  onAllIn,
  ...
  onSliderChange,
  onStraddle
}: PokerActionDockDesktopProps) {
  const { hero } = viewModel;
  const hiddenCards = hero.cards.some((card) => card === undefined) || !hero.cardsDecrypted;

  return (
    <section className="poker-gameplay-dock poker-gameplay-dock-desktop" aria-label="Player actions">
      <div className="poker-gameplay-dock-desktop-top">
        ...
        <div className="poker-gameplay-dock-raise-row desktop">
          <label htmlFor="poker-desktop-raise-input">Raise To</label>
          <input
            id="poker-desktop-raise-input"
      ...
      <div className="poker-gameplay-dock-primary-row">
        <button
          type="button"
        ...
        <button
          type="button"
          className="poker-gameplay-action-button check"
          disabled={!hero.isMyTurn || !hero.inBettingRound || !hero.canCheck || hero.actionLocked}
          onClick={onCheck}
        >
          Check
        </button>
        <button
          type="button"
          className="poker-gameplay-action-button call"
          disabled={!hero.isMyTurn || !hero.inBettingRound || hero.canCheck || hero.actionLocked}
          onClick={onCall}
        >
          Call {formatChips(hero.callAmount)}
        </button>
        <button
          type="button"
